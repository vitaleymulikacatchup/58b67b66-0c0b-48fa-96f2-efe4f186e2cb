...
export const metadata: Metadata = {
  ...
  description: "Experience championship basketball with the Los Angeles Lakers. Get tickets, team news, player updates, and merchandise for the purple and gold.",
  keywords: "Lakers, basketball, NBA, Los Angeles, tickets, schedule, LeBron James, Anthony Davis",
  metadataBase: new URL("https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764085700757-2hmexbk1.jpg"),
  alternates: {
    canonical: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764085700757-2hmexbk1.jpg"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    ...
    description: "Experience championship basketball with the Los Angeles Lakers. Get tickets, team news, player updates, and merchandise for the purple and gold.",
    type: "website",
    siteName: "Los Angeles Lakers",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764085700757-2hmexbk1.jpg",
      alt: "Lakers basketball arena"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Los Angeles Lakers - NBA Basketball",
    description: "Experience championship basketball with the Los Angeles Lakers. Join the legacy of greatness.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764085700757-2hmexbk1.jpg"]
  }
};
